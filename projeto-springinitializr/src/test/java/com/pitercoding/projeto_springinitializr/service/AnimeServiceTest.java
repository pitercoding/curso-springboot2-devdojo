...
import com.pitercoding.projeto_springinitializr.util.AnimePutRequestBodyCreator;
...
class AnimeServiceTest {
    ...
    void setUp() {
        ...
        BDDMockito.when(animeMapper.toAnime(ArgumentMatchers.any(AnimePostRequestBody.class))).thenReturn(AnimeCreator.createValidAnime());
    ...
    @Test
    @DisplayName("listAll returns a list of anime inside page object when successful")

...
public class AnimeController {
    ...
    @GetMapping
    @Operation(summary = "List all animes paginated", description = "The default size is 20, use the paramter size to change the default value",
    tags = {"anime"})
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "400", description = "When Anime does not exist on database")
    })
